...
//$router->get("/titles", "TitleListController@getTitles");
//$router->get("/titles/{id}", "TitleListController@getTitleListByID");
//$router->get("/titles/{chinese_title}", "TitleListController@getTitleListByChnTit");
//$router->get("/titles/{pinyin_title}", "TitleListController@getTitleListByPinTit");
